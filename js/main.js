...
$(window).scroll(function() {
	...
	$('.portfolio__gallery-1').each(function(){
		var imagePos = $(this).offset().top;
	...
	$('.mobile-gallery__wrapper').each(function(){
		var imagePos = $(this).offset().top;
	...
	$('.mobile-gallery__slider-preview').each(function(){
		var imagePos = $(this).offset().top;
	...
	$('.mobile-reviews__slider').each(function(){
		var imagePos = $(this).offset().top;
